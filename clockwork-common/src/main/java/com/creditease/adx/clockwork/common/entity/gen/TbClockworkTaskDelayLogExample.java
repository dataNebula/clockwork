...
public class TbClockworkTaskDelayLogExample {
    ...
    public TbClockworkTaskDelayLogExample() {
     ...
     * This class corresponds to the database table tb_clockwork_task_delay_log
     *

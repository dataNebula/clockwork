 ...
 * @ Description：任务分发例行Tuple信息
 * @ Modified By：
 */
@Getter
@Setter
public class TaskDistributeTupleRoutine extends TaskDistributeTuple {

    String URL = "http://%s:%s/clockwork/worker/task/run/batch/routine";

    private TasksGroupByStatus tasksGroupByStatus;

    @SuppressWarnings("unused")
	private TaskDistributeTupleRoutine(){}

    public TaskDistributeTupleRoutine(List<TbClockworkTaskPojo> tasksPojo, Integer nodeId) {

...
import com.creditease.adx.clockwork.web.service.IBaseRdmsService;
...
public abstract class AbstractBaseRdmsService<Entity, EntityPojo, EntityExample, EntityMapper>
    ...
    @Override
    public List<EntityPojo> convertEntitiesToPojos(List<Entity> entities) throws IllegalAccessException, InvocationTargetException {
    ...
    public List<Entity> select(Entity entity) throws Exception {
        EntityExample entityExample = (EntityExample) ReflectUtil
                .constructorNewInstance(ReflectUtil.getClassGenricType(this.getClass(), 2).getName());
        setEntityExampleCriteria(entity, null, MethodUtils.invokeExactMethod(entityExample, "createCriteria", null));

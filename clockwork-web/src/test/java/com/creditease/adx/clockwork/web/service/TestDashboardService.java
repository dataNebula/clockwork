...
public class TestDashboardService {
    ...
    @Test
    public void getTaskNodeHourRunTest() throws Exception {
        BarChartEntity taskNodeHourRun = dashboardService.getTaskNodeHourRun(null, null);

        System.out.println(taskNodeHourRun);

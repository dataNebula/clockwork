...
public class TestNodeGroupService {
    ...
    public void testCheckUser() throws Exception {
        List<TbClockworkNodeGroup> allNodeGroup = nodeGroupService.getAllNodeGroup();
        for (TbClockworkNodeGroup tbClockworkNodeGroup : allNodeGroup) {
            System.out.println(tbClockworkNodeGroup.getName());
        }

...
public interface TaskGroupMapper {
  ...
  List<Map<String,Object>> selectTaskGroupIdAndNameByUserGroupName(Map<String, String> param);

  int updateByPrimaryKeySelective(TbClockworkTaskGroup TbClockworkTaskGroup);
